...
init_config_local() {
    ...
    sed -i \
        ...
        -e "s#PARAM_VUFIND_ZISKEJ_API_USERNAME#${PARAM_VUFIND_ZISKEJ_API_USERNAME}#g" \
        -e "s#PARAM_VUFIND_ZISKEJ_API_PASSWORD#${PARAM_VUFIND_ZISKEJ_API_PASSWORD}#g" \
        -e "s#PARAM_VUFIND_REDIS_HOST#${PARAM_VUFIND_REDIS_HOST}#g" \
        -e "s#PARAM_VUFIND_REDIS_PASSWORD#${PARAM_VUFIND_REDIS_PASSWORD}#g" \
        -e "s#PARAM_FILEBEAT_HOST#${PARAM_FILEBEAT_HOST}#g" \
        -e "s#PARAM_FILEBEAT_PORT#${PARAM_FILEBEAT_PORT}#g" \
        "$CONFIG_LOCAL"
